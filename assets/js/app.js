...
function reloadCalenderContent() {
  ...
  newscript1.src = "assets/plugins/taskbar_calender/js/caleandar.min.js";
  newscript1.id = "reload1";
  let newscript2 = document.createElement("script");
  newscript2.type = "text/javascript";
  newscript2.id = "reload2";
  newscript2.src = "assets/plugins/taskbar_calender/js/demo.js";
...
function CreateModal(icon, src) {
  ...
  if (
    ...
    let panel = jsPanel
      ...
      .setHeaderLogo(
        '<img src="assets/resources/images/icons/' +
          iconName +
          "." +
          icon[1] +
...
function addIconToTaskbar(fileName, fileExtension, tagType) {
  ...
  if (tagType == "img") {
    ...
    img.src = "assets/resources/images/icons/" + fileName + "." + fileExtension;
    img.height = "32";
    img.width = "32";
